...
%TOM_CALCANGCONV calculates random angular distances for dot product
%anglegs between two vectors in DEGREE [0 180]!!
%
%
...
%
%  INPUT
%   measuredAngles      inputAngles 0-180 deg
...
%EXAMPLE
% parpool('local',25);
% tom_calcAngConv(rand(500,1)*180,0:10:180,'paritcles class1');
%
% load vectOutPlaneAlg/list.txt
% tom_calcAngConv(list(:,10),0:10:180,'mother vs. plane');
% 
% %2d case
